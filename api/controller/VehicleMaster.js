...
async function DeleteVehicleMaster(req, res, next) {
    const {v_type, v_wt} = req.body;
    
    const sql = `DELETE FROM Toll_VehicleMaster WHERE v_type='${v_type}' AND v_wt='${v_wt}'`
...
module.exports = {AddVehicleMaster, FetchVehicleMaster, EditVehicleMaster, DeleteVehicleMaster};
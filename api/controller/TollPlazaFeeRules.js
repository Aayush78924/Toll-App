...
async function DeleteTollPlazaFeeRules(req, res, next) {
    const {v_type, j_type, amount, currdata} = req.body;
    
    const sql = `DELETE FROM Toll_TollPlazaFeeRules WHERE v_type='${v_type}' AND j_type='${j_type}' AND amount='${amount}'`
...
module.exports = {AddTollPlazaFeeRules, FetchTollPlazaFeeRules, EditTollPlazaFeeRules, DeleteTollPlazaFeeRules, FetchAmount};
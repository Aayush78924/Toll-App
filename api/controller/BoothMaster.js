...
async function DeleteBoothMaster(req, res, next) {
    const {boothno, ipaddress} = req.body;
    
    const sql = `DELETE FROM Toll_BoothMaster WHERE boothno='${boothno}' AND ipaddress='${ipaddress}'`
...
module.exports = {AddBoothMaster, FetchBoothMaster, EditBoothMaster, DeleteBoothMaster};
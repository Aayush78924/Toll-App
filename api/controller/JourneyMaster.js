...
async function DeleteJourneyMaster(req, res, next) {
    const {j_type} = req.body;
    
    const sql = `DELETE FROM Toll_JourneyMaster WHERE j_type='${j_type}'`
...
module.exports = {AddJourneyMaster, FetchJourneyMaster, EditJourneyMaster, DeleteJourneyMaster};
...
async function DeleteUser(req, res, next) {
    ...
    const sql = `DELETE FROM Toll_User WHERE name='${name}' AND pass='${pass}' AND empcode='${empcode}' AND toll='${toll}' AND lane='${lane}'`
...
module.exports = {AddUser, FetchUser, EditUser, DeleteUser};
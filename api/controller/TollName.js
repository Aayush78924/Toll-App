...
async function DeleteTollName(req, res, next) {
    const {toll} = req.body;
    
    const sql = `DELETE FROM Toll_TollName WHERE toll='${toll}'`
...
module.exports = {AddTollName, FetchTollName, EditTollName, DeleteTollName};